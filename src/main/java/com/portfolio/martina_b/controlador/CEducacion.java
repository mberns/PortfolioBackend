...
public class CEducacion {
    ...
    @Autowired
    SEducacion sEducacion; //llamamos al service

    //desarrollamos los metodos
    @GetMapping("/lista")
    ...
    public ResponseEntity<?> delete(@PathVariable("id") int id) { //vamos a eliminar por id
        if (!sEducacion.existsById(id)) { //si no existe
            return new ResponseEntity(new Mensaje("No existe el id"), HttpStatus.NOT_FOUND);
        }
    ...
    public ResponseEntity<?> create(@RequestBody DtoEducacion dtoeducacion) {
        ...
        sEducacion.save(educacion); //en el service se guarda nombre y  descripcion
